...
<style>
/*
 * CSS is based on CSS from Thibaut Courouble. His copyright notice is
...
.configure input[type=text], .configure input[type=password] {
  width: 278px;
}
...
<div class="configure">
  ...
  <form method="get" action="/configuration">
    ...
    <p>
      <label>
        To get started, enter your wifi name (router name) and its password and hit connect. This display will then restart and attempt to connect to your wifi. 
      </label>
    </p>
    <p>
      <label class="warning">

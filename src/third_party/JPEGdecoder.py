################################################################################
# This file is copied from https://github.com/remixer-dec/mpy-img-decoder
# It uses the GPL v3 licence and - according to my understanding of GPL -
# it therefore "infects" all of this project with GPL restrictions too,
# overriding my chosen MIT licence. If you wish to re-use parts of this
# project with just the MIT licence, you'll need to remove this file, and
# find a replacement if the functionality is required.
# 
# The GLP v3 licence can be found at https://www.gnu.org/licenses/gpl-3.0.txt
################################################################################
